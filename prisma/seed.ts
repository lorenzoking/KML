...
async function main() {
  ...
  await prisma.leagueStoryComment.deleteMany();
  await prisma.leagueStoryLike.deleteMany();
    ...
    [
      {
        ...
        coreBenefit: "Access to 2 Quarterback Development Camps every offseason.",
        restriction: "No development camps for wide receivers or running backs.",
        changeRule: coachChangeRule,
        xpCost: 0,
        level: "QB whisperer",
        minRepScore: 0,
      },
      {
        ...
        coreBenefit: "Access to 2 Offensive Skill Camps every offseason.",
        restriction: "No quarterback-specific camps.",
        changeRule: coachChangeRule,
        xpCost: 0,
      ...
      },
      {
        ...
        coreBenefit: "Access to 2 Offensive Line Camps and 2 Defensive Line Camps.",
        restriction: "No WR/RB development camps.",
        changeRule: coachChangeRule,
        xpCost: 0,
        level: "Trench builder",
        minRepScore: 0,
      },
      {
        name: "Defensive Guru",
        slug: "coach-defensive-guru",
        coreBenefit: "Access to 3 Defensive Development Camps every offseason.",
        restriction: "Offensive camps reduced to one total.",
        changeRule: coachChangeRule,
        xpCost: 0,
        level: "Defensive guru",
        minRepScore: 0,
      },
      {
        name: "RB Guru",
        slug: "coach-rb-guru",
        coreBenefit: "Access to 2 Running Back Camps and 1 Offensive Line Camp.",
        restriction: "No quarterback camps.",
        changeRule: coachChangeRule,
        xpCost: 0,
        level: "RB guru",
        minRepScore: 0,
      },
      {
        ...
        coreBenefit: "Receive 2 Flexible Development Camps every offseason.",
        restriction:
          "Cannot assign more than one camp to the same position group during the same offseason.",
        changeRule: coachChangeRule,
        xpCost: 0,
        level: "Culture builder",
        minRepScore: 0,
      },
    ].map((identity) =>
      prisma.identityCatalog.create({
