...
export const GAMEPLAY_QUICK_FACTS = [
  ...
  { label: "Pass/run", value: "At least 50% pass" },
...
export const GAMEPLAY_RULE_SECTIONS: GameplayRuleSection[] = [
  {
    ...
    items: [
      ...
      "Game scores and coach XP come from the Madden Companion export. Coaches submit Sim Scores, not the final score",
      "A Madden game that was actually played awards game-played XP to both coaches. CPU sims after the week is done award play XP only to the winner if nobody filed a force win",
